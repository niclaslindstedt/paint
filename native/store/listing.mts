...
export const RULES: StoreRules = {
  ...
  brand: {
    ...
    marketingUrl: "https://paint.niclaslindstedt.se/",
    ...
    // behaviour does.
    privacyUrl: "https://apps.agilator.se/paint/privacy/",
    supportUrl: "https://apps.agilator.se/paint/support/",
  },

  // Paint ships on the App Store alone. The desktop shell exists (`tauri/`)
  ...
  apple: {
    // A sketchpad. GRAPHICS_AND_DESIGN is where somebody looking for one
    // looks; PRODUCTIVITY second, for the diagrams and notes it is also
    // used for.
    categories: ["GRAPHICS_AND_DESIGN", "PRODUCTIVITY"],

    advisory: {
      // A drawing app. Every row is NONE and none of them is a judgement call:
      // the app ships no pictures of its own — a page holds what the reader
      // drew or placed there themselves, and nothing is shared from it.
