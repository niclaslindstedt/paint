...
// store: every drawing the user has made would appear to vanish. The port
 ...
 *  the first one is what keeps the user's drawings across launches.
 *
...
const PORT_LADDER = [8271, 8272, 8273] as const;
...
export type LocalServer = {
  /** The origin to point the WebView at, e.g. `http://localhost:8271`. */
  origin: string;
  stop: () => Promise<void>;
};
