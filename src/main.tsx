...
// but only once their loaders are registered, which is what this side-effect
// import does. The framework keeps the `@fontsource/*` specifiers behind their
// own entry so an app shipping none of them can still import a `Button`
// without its bundler resolving font packages it does not have; an app that
// *does* want them says so once, here. Drop this line and the appearance
// picker still offers Inter, Source Serif and OpenDyslexic — and picking one
// silently paints the fallback stack.
