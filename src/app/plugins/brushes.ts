...
// that make an airbrush read as an airbrush and a crayon as wax, rather than as
// a pencil with a different width. (The bristle brush outgrew this file and
// lives in `bristle.ts`; the hashes they all scatter with are in `grain.ts`.)
//
