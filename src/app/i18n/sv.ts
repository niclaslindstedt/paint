...
export const sv: Catalog = {
  ...
  effects: {
    ...
    brightness: {
      name: "Ljus & kontrast",
      hint: "Höjer eller sänker ljuset i märkena och drar isär eller ihop tonerna.",
      brightness: "Ljus: {value}%",
      contrast: "Kontrast: {value}%",
    },
    levels: {
      name: "Nivåer",
      hint: "Säger vilken ton som räknas som svart, vilken som räknas som vit och var mitten ligger mellan dem.",
    ...
    curves: {
      name: "Kurvor",
      hint: "Böjer hela tonomfånget för hand – lyft skuggorna, dämpa högdagrarna eller färgsätt en kanal mot de andra.",
      channel: "Kanal",
      channelRgb: "RGB",
      channelRed: "Röd",
      channelGreen: "Grön",
      ...
      editor: "Tonkurva",
      editorHint:
        "Dra i linjen för att böja den. Tryck på den för att lägga till en punkt, dra en punkt utanför rutan för att ta bort den, eller använd piltangenterna.",
      reset: "Räta ut",
    },
    hue: {
      name: "Nyans & mättnad",
      hint: "Vrider varje färg runt cirkeln och säger hur stark och hur ljus den blir.",
      hue: "Nyans: {value}°",
      saturation: "Mättnad: {value}%",
      lightness: "Ljushet: {value}%",
    },
    balance: {
      name: "Färgbalans",
      hint: "Värmer eller kyler en ände av tonomfånget utan att röra de andra två.",
      range: "Toner",
      rangeShadows: "Skuggor",
      rangeMidtones: "Mellantoner",
      rangeHighlights: "Högdagrar",
      red: "Cyan – Röd: {value}",
      green: "Magenta – Grön: {value}",
      blue: "Gul – Blå: {value}",
      luminosity: "Behåll ljuset",
      luminosityHint:
        "Flytta färgerna utan att ändra hur ljus varje bildpunkt är.",
    },
    desaturate: {
      name: "Avmätta",
      hint: "Tömmer ut färgen och lämnar kvar ljuset. Hela vägen ger en svartvit bild.",
      amount: "Mängd: {value}%",
    },
  },
  panel: {
  ...
  settings: {
    ...
    general: {
      ...
      showPixelGridHint:
        "Över 800 % rutas sidan upp i enskilda pixlar — rutorna som en exporterad bild löser upp i — helt intonat vid 1000 %. Bara en hjälplinje; det exporteras aldrig.",
